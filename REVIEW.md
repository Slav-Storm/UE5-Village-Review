...
![Seven-view contact sheet](latest/00_contact_sheet.png)
...
![Aerial overview](latest/01_aerial.png)
...
![Church and cemetery](latest/04_cemetery.png)
...
![Witch's home and cellar](latest/05_witch_house.png)
...
![Mayor's staircase approach](latest/06_mayor_approach.png)
...
![The two disturbed graves](latest/07_disturbed_graves.png)
...
![Future burial land](latest/08_cemetery_reserve.png)
...
![Ordinary family yard](latest/09_family_yard.png)
...
![Mayor's cart/service route](latest/10_cart_service.png)

### 11. Cellar threshold

Player-height view from the new side landing into the existing cellar stair and underground space.

![Cellar threshold](latest/11_cellar_threshold.png)
